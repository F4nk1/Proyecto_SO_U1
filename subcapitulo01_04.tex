...
\caption{Razones comunes para la creación de procesos en un sistema operativo. Fuente: \cite{sistemas_operativos}}
\label{tab:razones_creacion_procesos}
\end{table}
...
\end{tabular}
\renewcommand{\tablename}{Tabla}
\caption{La tabla refleja cómo los sistemas operativos gestionan y controlan la ejecución de procesos, garantizando estabilidad, seguridad y uso eficiente de los recursos. fuente: \cite{sistemas_operativos}}
\label{tab:razones_terminacion}
\end{table}
