...
\begin{figure}[H]
    ...
    \caption[Monolithic kernel based operating system]%
            {Monolithic kernel based operating system \citep{harshvardhan2023kernels}}
...
\begin{figure}[H]
    ...
    \caption[Microkernel based operating system]%
            {Microkernel based operating system \citep{harshvardhan2023kernels}}
...
\begin{figure}[H]
    ...
    \caption[Hybridkernel based operating system]%
            {Hybridkernel based operating system \citep{harshvardhan2023kernels}}
...
\begin{figure}[H]
    ...
    \caption[Exokernel based operating]%
            {Exokernel based operating system \citep{exokernel1995}}
...
\begin{muntab}{|c|p{5cm}|p{5cm}|}
  {comparacion_kernel}
  {Comparación de arquitecturas de SO \citep{harshvardhan2023kernels}}
\hline
